# Generated by Django 4.2.1 on 2024-05-26 20:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='MovieMetaData',
            fields=[
                ('Unnamed: 0', models.IntegerField(default=0)),
                ...
                ('movie', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='movie.movie')),
            ],
            options={
                'abstract': False,
            },
